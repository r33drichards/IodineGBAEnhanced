...
SaveStateManager.prototype.saveState = function (slot) {
    ...
    this.slot[slot] = new SaveState({IOCore: this.Iodine.IOCore});
...
function SaveState(arg) {
    ...
    if (arg.IOCore) {
    /* General */
    this.accumulatedClocks            = structuredClone(arg.IOCore.accumulatedClocks            );
    this.cyclesOveriteratedPreviously = structuredClone(arg.IOCore.cyclesOveriteratedPreviously );
    this.cyclesToIterate              = structuredClone(arg.IOCore.cyclesToIterate              );
    this.graphicsClocks               = structuredClone(arg.IOCore.graphicsClocks               );
    this.nextEventClocks              = structuredClone(arg.IOCore.nextEventClocks              );
    this.systemStatus                 = structuredClone(arg.IOCore.systemStatus                 );
    this.timerClocks                  = structuredClone(arg.IOCore.timerClocks                  );

    /* Memory */
    this.internalRAM               = structuredClone(arg.IOCore.memory.internalRAM             );
    this.externalRAM               = structuredClone(arg.IOCore.memory.externalRAM             );
    this.WRAMControlFlags          = structuredClone(arg.IOCore.memory.WRAMControlFlags        );
    this.lastBIOSREAD              = structuredClone(arg.IOCore.memory.lastBIOSREAD            );
  
    /* DMA */
    this.dma = {};  
    this.dma.currentMatch          = structuredClone(arg.IOCore.dma.currentMatch               );
    this.dma.fetch                 = structuredClone(arg.IOCore.dma.fetch                      );

    this.dma0 = {}; 
    this.dma0.destination          = structuredClone(arg.IOCore.dmaChannel0.destination        );     
    this.dma0.destinationControl   = structuredClone(arg.IOCore.dmaChannel0.destinationControl );                   
    this.dma0.destinationShadow    = structuredClone(arg.IOCore.dmaChannel0.destinationShadow  );                 
    this.dma0.dmaType              = structuredClone(arg.IOCore.dmaChannel0.dmaType            );        
    this.dma0.enabled              = structuredClone(arg.IOCore.dmaChannel0.enabled            );         
    this.dma0.irqFlagging          = structuredClone(arg.IOCore.dmaChannel0.irqFlagging        );     
    this.dma0.is32Bit              = structuredClone(arg.IOCore.dmaChannel0.is32Bit            );         
    this.dma0.pending              = structuredClone(arg.IOCore.dmaChannel0.pending            );          
    this.dma0.repeat               = structuredClone(arg.IOCore.dmaChannel0.repeat             );       
    this.dma0.source               = structuredClone(arg.IOCore.dmaChannel0.source             );      
    this.dma0.sourceControl        = structuredClone(arg.IOCore.dmaChannel0.sourceControl      );         
    this.dma0.sourceShadow         = structuredClone(arg.IOCore.dmaChannel0.sourceShadow       );       
    this.dma0.wordCount            = structuredClone(arg.IOCore.dmaChannel0.wordCount          );              
    this.dma0.wordCountShadow      = structuredClone(arg.IOCore.dmaChannel0.wordCountShadow    );
    
    this.dma1 = {}; 
    this.dma1.destination          = structuredClone(arg.IOCore.dmaChannel1.destination        );     
    this.dma1.destinationControl   = structuredClone(arg.IOCore.dmaChannel1.destinationControl );                   
    this.dma1.destinationShadow    = structuredClone(arg.IOCore.dmaChannel1.destinationShadow  );                 
    this.dma1.dmaType              = structuredClone(arg.IOCore.dmaChannel1.dmaType            );        
    this.dma1.enabled              = structuredClone(arg.IOCore.dmaChannel1.enabled            );         
    this.dma1.irqFlagging          = structuredClone(arg.IOCore.dmaChannel1.irqFlagging        );     
    this.dma1.is32Bit              = structuredClone(arg.IOCore.dmaChannel1.is32Bit            );         
    this.dma1.pending              = structuredClone(arg.IOCore.dmaChannel1.pending            );          
    this.dma1.repeat               = structuredClone(arg.IOCore.dmaChannel1.repeat             );       
    this.dma1.source               = structuredClone(arg.IOCore.dmaChannel1.source             );      
    this.dma1.sourceControl        = structuredClone(arg.IOCore.dmaChannel1.sourceControl      );         
    this.dma1.sourceShadow         = structuredClone(arg.IOCore.dmaChannel1.sourceShadow       );       
    this.dma1.wordCount            = structuredClone(arg.IOCore.dmaChannel1.wordCount          );              
    this.dma1.wordCountShadow      = structuredClone(arg.IOCore.dmaChannel1.wordCountShadow    );     

    this.dma2 = {}; 
    this.dma2.destination          = structuredClone(arg.IOCore.dmaChannel2.destination        );     
    this.dma2.destinationControl   = structuredClone(arg.IOCore.dmaChannel2.destinationControl );                   
    this.dma2.destinationShadow    = structuredClone(arg.IOCore.dmaChannel2.destinationShadow  );                 
    this.dma2.dmaType              = structuredClone(arg.IOCore.dmaChannel2.dmaType            );        
    this.dma2.enabled              = structuredClone(arg.IOCore.dmaChannel2.enabled            );         
    this.dma2.irqFlagging          = structuredClone(arg.IOCore.dmaChannel2.irqFlagging        );     
    this.dma2.is32Bit              = structuredClone(arg.IOCore.dmaChannel2.is32Bit            );         
    this.dma2.pending              = structuredClone(arg.IOCore.dmaChannel2.pending            );          
    this.dma2.repeat               = structuredClone(arg.IOCore.dmaChannel2.repeat             );       
    this.dma2.source               = structuredClone(arg.IOCore.dmaChannel2.source             );      
    this.dma2.sourceControl        = structuredClone(arg.IOCore.dmaChannel2.sourceControl      );         
    this.dma2.sourceShadow         = structuredClone(arg.IOCore.dmaChannel2.sourceShadow       );       
    this.dma2.wordCount            = structuredClone(arg.IOCore.dmaChannel2.wordCount          );              
    this.dma2.wordCountShadow      = structuredClone(arg.IOCore.dmaChannel2.wordCountShadow    );

    this.dma3 = {}; 
    this.dma3.destination            =  structuredClone(arg.IOCore.dmaChannel3.destination            );      
    this.dma3.destinationControl     =  structuredClone(arg.IOCore.dmaChannel3.destinationControl     );             
    this.dma3.destinationShadow      =  structuredClone(arg.IOCore.dmaChannel3.destinationShadow      );            
    this.dma3.displaySyncEnableDelay =  structuredClone(arg.IOCore.dmaChannel3.displaySyncEnableDelay );                 
    this.dma3.dmaType                =  structuredClone(arg.IOCore.dmaChannel3.dmaType                );  
    this.dma3.enabled                =  structuredClone(arg.IOCore.dmaChannel3.enabled                );  
    this.dma3.gamePakDMA             =  structuredClone(arg.IOCore.dmaChannel3.gamePakDMA             );     
    this.dma3.irqFlagging            =  structuredClone(arg.IOCore.dmaChannel3.irqFlagging            );      
    this.dma3.is32Bit                =  structuredClone(arg.IOCore.dmaChannel3.is32Bit                );  
    this.dma3.pending                =  structuredClone(arg.IOCore.dmaChannel3.pending                );  
    this.dma3.repeat                 =  structuredClone(arg.IOCore.dmaChannel3.repeat                 ); 
    this.dma3.source                 =  structuredClone(arg.IOCore.dmaChannel3.source                 ); 
    this.dma3.sourceControl          =  structuredClone(arg.IOCore.dmaChannel3.sourceControl          );        
    this.dma3.sourceShadow           =  structuredClone(arg.IOCore.dmaChannel3.sourceShadow           );       
    this.dma3.wordCount              =  structuredClone(arg.IOCore.dmaChannel3.wordCount              );    
    this.dma3.wordCountShadow        =  structuredClone(arg.IOCore.dmaChannel3.wordCountShadow        );          
    
    /* CPU */               
    this.registers                 = structuredClone(arg.IOCore.cpu.registers                );
    this.registersUSR              = structuredClone(arg.IOCore.cpu.registersUSR             );
    this.registersFIQ              = structuredClone(arg.IOCore.cpu.registersFIQ             );
    this.registersSVC              = structuredClone(arg.IOCore.cpu.registersSVC             );
    this.registersABT              = structuredClone(arg.IOCore.cpu.registersABT             );
    this.registersIRQ              = structuredClone(arg.IOCore.cpu.registersIRQ             );
    this.registersUND              = structuredClone(arg.IOCore.cpu.registersUND             );
    this.modeFlags                 = structuredClone(arg.IOCore.cpu.modeFlags                );
    this.SPSR                      = structuredClone(arg.IOCore.cpu.SPSR                     );
    this.mul64ResultHigh           = structuredClone(arg.IOCore.cpu.mul64ResultHigh          );
    this.mul64ResultLow            = structuredClone(arg.IOCore.cpu.mul64ResultLow           );
    this.triggeredIRQ              = structuredClone(arg.IOCore.cpu.triggeredIRQ             );

    this.THUMB = {};
    this.THUMB.decode              = structuredClone(arg.IOCore.THUMB.decode                 );
    this.THUMB.execute             = structuredClone(arg.IOCore.THUMB.execute                );
    this.THUMB.fetch               = structuredClone(arg.IOCore.THUMB.fetch                  );

    this.ARM = {};
    this.ARM.decode                = structuredClone(arg.IOCore.ARM.decode                   );
    this.ARM.execute               = structuredClone(arg.IOCore.ARM.execute                  );
    this.ARM.fetch                 = structuredClone(arg.IOCore.ARM.fetch                    );
         
    /* Timers */         
    this.timer0Counter             = structuredClone(arg.IOCore.timer.timer0Counter          );
    this.timer0Reload              = structuredClone(arg.IOCore.timer.timer0Reload           );
    this.timer0Control             = structuredClone(arg.IOCore.timer.timer0Control          );
    this.timer0Enabled             = structuredClone(arg.IOCore.timer.timer0Enabled          ); 
    this.timer0IRQ                 = structuredClone(arg.IOCore.timer.timer0IRQ              ); 
    this.timer0Precounter          = structuredClone(arg.IOCore.timer.timer0Precounter       );
    this.timer0Prescalar           = structuredClone(arg.IOCore.timer.timer0Prescalar        );
    this.timer0PrescalarShifted    = structuredClone(arg.IOCore.timer.timer0PrescalarShifted );
    this.timer1Counter             = structuredClone(arg.IOCore.timer.timer1Counter          );
    this.timer1Reload              = structuredClone(arg.IOCore.timer.timer1Reload           );
    this.timer1Control             = structuredClone(arg.IOCore.timer.timer1Control          );
    this.timer1Enabled             = structuredClone(arg.IOCore.timer.timer1Enabled          ); 
    this.timer1IRQ                 = structuredClone(arg.IOCore.timer.timer1IRQ              ); 
    this.timer1Precounter          = structuredClone(arg.IOCore.timer.timer1Precounter       );
    this.timer1Prescalar           = structuredClone(arg.IOCore.timer.timer1Prescalar        );
    this.timer1PrescalarShifted    = structuredClone(arg.IOCore.timer.timer1PrescalarShifted );
    this.timer1CountUp             = structuredClone(arg.IOCore.timer.timer1CountUp          ); 
    this.timer2Counter             = structuredClone(arg.IOCore.timer.timer2Counter          );
    this.timer2Reload              = structuredClone(arg.IOCore.timer.timer2Reload           );
    this.timer2Control             = structuredClone(arg.IOCore.timer.timer2Control          );
    this.timer2Enabled             = structuredClone(arg.IOCore.timer.timer2Enabled          ); 
    this.timer2IRQ                 = structuredClone(arg.IOCore.timer.timer2IRQ              ); 
    this.timer2Precounter          = structuredClone(arg.IOCore.timer.timer2Precounter       );
    this.timer2Prescalar           = structuredClone(arg.IOCore.timer.timer2Prescalar        );
    this.timer2PrescalarShifted    = structuredClone(arg.IOCore.timer.timer2PrescalarShifted );
    this.timer2CountUp             = structuredClone(arg.IOCore.timer.timer2CountUp          ); 
    this.timer3Counter             = structuredClone(arg.IOCore.timer.timer3Counter          );
    this.timer3Reload              = structuredClone(arg.IOCore.timer.timer3Reload           );
    this.timer3Control             = structuredClone(arg.IOCore.timer.timer3Control          );
    this.timer3Enabled             = structuredClone(arg.IOCore.timer.timer3Enabled          ); 
    this.timer3IRQ                 = structuredClone(arg.IOCore.timer.timer3IRQ              ); 
    this.timer3Precounter          = structuredClone(arg.IOCore.timer.timer3Precounter       );
    this.timer3Prescalar           = structuredClone(arg.IOCore.timer.timer3Prescalar        );
    this.timer3PrescalarShifted    = structuredClone(arg.IOCore.timer.timer3PrescalarShifted );
    this.timer3CountUp             = structuredClone(arg.IOCore.timer.timer3CountUp          ); 
    this.timer1UseMainClocks       = structuredClone(arg.IOCore.timer.timer1UseMainClocks    ); 
    this.timer1UseChainedClocks    = structuredClone(arg.IOCore.timer.timer1UseChainedClocks ); 
    this.timer2UseMainClocks       = structuredClone(arg.IOCore.timer.timer2UseMainClocks    ); 
    this.timer2UseChainedClocks    = structuredClone(arg.IOCore.timer.timer2UseChainedClocks ); 
    this.timer3UseMainClocks       = structuredClone(arg.IOCore.timer.timer3UseMainClocks    ); 
    this.timer3UseChainedClocks    = structuredClone(arg.IOCore.timer.timer3UseChainedClocks );  
   
    /* Wait */   
    this.WRAMConfiguration         = structuredClone(arg.IOCore.wait.WRAMConfiguration       );  
    this.WRAMWaitState             = structuredClone(arg.IOCore.wait.WRAMWaitState           );      
    this.SRAMWaitState             = structuredClone(arg.IOCore.wait.SRAMWaitState           );      
    this.WAITCNT0                  = structuredClone(arg.IOCore.wait.WAITCNT0                );           
    this.WAITCNT1                  = structuredClone(arg.IOCore.wait.WAITCNT1                );           
    this.POSTBOOT                  = structuredClone(arg.IOCore.wait.POSTBOOT                );           
    this.isRendering               = structuredClone(arg.IOCore.wait.isRendering             );        
    this.isOAMRendering            = structuredClone(arg.IOCore.wait.isOAMRendering          );     
    this.nonSequential             = structuredClone(arg.IOCore.wait.nonSequential           );      
    this.buffer                    = structuredClone(arg.IOCore.wait.buffer                  );             
    this.clocks                    = structuredClone(arg.IOCore.wait.clocks                  );         


    /* Serial */
    this.SIODATA_A                 = structuredClone(arg.IOCore.serial.SIODATA_A                );     
    this.SIODATA_B                 = structuredClone(arg.IOCore.serial.SIODATA_B                );     
    this.SIODATA_C                 = structuredClone(arg.IOCore.serial.SIODATA_C                );     
    this.SIODATA_D                 = structuredClone(arg.IOCore.serial.SIODATA_D                );     
    this.SIOShiftClockExternal     = structuredClone(arg.IOCore.serial.SIOShiftClockExternal    );     
    this.SIOShiftClockDivider      = structuredClone(arg.IOCore.serial.SIOShiftClockDivider     );     
    this.SIOCNT0_DATA              = structuredClone(arg.IOCore.serial.SIOCNT0_DATA             );     
    this.SIOTransferStarted        = structuredClone(arg.IOCore.serial.SIOTransferStarted       );     
    this.SIOMULT_PLAYER_NUMBER     = structuredClone(arg.IOCore.serial.SIOMULT_PLAYER_NUMBER    );     
    this.SIOCOMMERROR              = structuredClone(arg.IOCore.serial.SIOCOMMERROR             );     
    this.SIOBaudRate               = structuredClone(arg.IOCore.serial.SIOBaudRate              );     
    this.SIOCNT_UART_CTS           = structuredClone(arg.IOCore.serial.SIOCNT_UART_CTS          );   
    this.SIOCNT_UART_MISC          = structuredClone(arg.IOCore.serial.SIOCNT_UART_MISC         );     
    this.SIOCNT_UART_FIFO          = structuredClone(arg.IOCore.serial.SIOCNT_UART_FIFO         );     
    this.SIOCNT_IRQ                = structuredClone(arg.IOCore.serial.SIOCNT_IRQ               );     
    this.SIOCNT_MODE               = structuredClone(arg.IOCore.serial.SIOCNT_MODE              );     
    this.SIOCNT_UART_RECV_ENABLE   = structuredClone(arg.IOCore.serial.SIOCNT_UART_RECV_ENABLE  );      
    this.SIOCNT_UART_SEND_ENABLE   = structuredClone(arg.IOCore.serial.SIOCNT_UART_SEND_ENABLE  );      
    this.SIOCNT_UART_PARITY_ENABLE = structuredClone(arg.IOCore.serial.SIOCNT_UART_PARITY_ENABLE);       
    this.SIOCNT_UART_FIFO_ENABLE   = structuredClone(arg.IOCore.serial.SIOCNT_UART_FIFO_ENABLE  );      
    this.SIODATA8                  = structuredClone(arg.IOCore.serial.SIODATA8                 );     
    this.RCNTMode                  = structuredClone(arg.IOCore.serial.RCNTMode                 );     
    this.RCNTIRQ                   = structuredClone(arg.IOCore.serial.RCNTIRQ                  );   
    this.RCNTDataBits              = structuredClone(arg.IOCore.serial.RCNTDataBits             );     
    this.RCNTDataBitFlow           = structuredClone(arg.IOCore.serial.RCNTDataBitFlow          );     
    this.JOYBUS_IRQ                = structuredClone(arg.IOCore.serial.JOYBUS_IRQ               );     
    this.JOYBUS_CNTL_FLAGS         = structuredClone(arg.IOCore.serial.JOYBUS_CNTL_FLAGS        );     
    this.JOYBUS_RECV0              = structuredClone(arg.IOCore.serial.JOYBUS_RECV0             );     
    this.JOYBUS_RECV1              = structuredClone(arg.IOCore.serial.JOYBUS_RECV1             );     
    this.JOYBUS_RECV2              = structuredClone(arg.IOCore.serial.JOYBUS_RECV2             );     
    this.JOYBUS_RECV3              = structuredClone(arg.IOCore.serial.JOYBUS_RECV3             );     
    this.JOYBUS_SEND0              = structuredClone(arg.IOCore.serial.JOYBUS_SEND0             );     
    this.JOYBUS_SEND1              = structuredClone(arg.IOCore.serial.JOYBUS_SEND1             );     
    this.JOYBUS_SEND2              = structuredClone(arg.IOCore.serial.JOYBUS_SEND2             );     
    this.JOYBUS_SEND3              = structuredClone(arg.IOCore.serial.JOYBUS_SEND3             );     
    this.JOYBUS_STAT               = structuredClone(arg.IOCore.serial.JOYBUS_STAT              );     
    this.shiftClocks               = structuredClone(arg.IOCore.serial.shiftClocks              );     
    this.serialBitsShifted         = structuredClone(arg.IOCore.serial.serialBitsShifted        );     
    ...
    this.graphicsClocks                = structuredClone(arg.IOCore.graphicsClocks              );
    this.timerClocks                   = structuredClone(arg.IOCore.timerClocks                 );
    this.serialClocks                  = structuredClone(arg.IOCore.serialClocks                );
    this.nextEventClocks               = structuredClone(arg.IOCore.nextEventClocks             );

    /* IRQ */
    this.interruptsEnabled             = structuredClone(arg.IOCore.irq.interruptsEnabled       );
    this.interruptsRequested           = structuredClone(arg.IOCore.irq.interruptsRequested     );
    this.IME                           = structuredClone(arg.IOCore.irq.IME                     );

    /* Video */
    this.renderedScanLine              = structuredClone(arg.IOCore.gfxState.renderedScanLine   );
    this.statusFlags                   = structuredClone(arg.IOCore.gfxState.statusFlags        );
    this.IRQFlags                      = structuredClone(arg.IOCore.gfxState.IRQFlags           );
    this.VCounter                      = structuredClone(arg.IOCore.gfxState.VCounter           );
    this.currentScanLine               = structuredClone(arg.IOCore.gfxState.currentScanLine    );
    this.LCDTicks                      = structuredClone(arg.IOCore.gfxState.LCDTicks           );

    this.IOData8                       = structuredClone(arg.IOCore.gfxRenderer.IOData8         );

    this.renderer = {};
    this.renderer.displayControl                = structuredClone(arg.IOCore.gfxRenderer.renderer.displayControl     ); 
    this.renderer.display                       = structuredClone(arg.IOCore.gfxRenderer.renderer.display            ); 
    this.renderer.greenSwap                     = structuredClone(arg.IOCore.gfxRenderer.renderer.greenSwap          ); 
    this.renderer.WINOutside                    = structuredClone(arg.IOCore.gfxRenderer.renderer.WINOutside         ); 
    this.renderer.paletteRAM                    = structuredClone(arg.IOCore.gfxRenderer.renderer.paletteRAM         ); 
    this.renderer.VRAM                          = structuredClone(arg.IOCore.gfxRenderer.renderer.VRAM               ); 
    this.renderer.buffer                        = structuredClone(arg.IOCore.gfxRenderer.renderer.buffer             ); 
    this.renderer.frameBuffer                   = structuredClone(arg.IOCore.gfxRenderer.renderer.frameBuffer        ); 
    this.renderer.swizzledFrame                 = structuredClone(arg.IOCore.gfxRenderer.renderer.swizzledFrame      ); 
    this.renderer.totalLinesPassed              = structuredClone(arg.IOCore.gfxRenderer.renderer.totalLinesPassed   ); 
    this.renderer.queuedScanLines               = structuredClone(arg.IOCore.gfxRenderer.renderer.queuedScanLines    ); 
    this.renderer.lastUnrenderedLine            = structuredClone(arg.IOCore.gfxRenderer.renderer.lastUnrenderedLine ); 
    this.renderer.backdrop                      = structuredClone(arg.IOCore.gfxRenderer.renderer.backdrop           ); 
    this.renderer.palette256                    = structuredClone(arg.IOCore.gfxRenderer.renderer.palette256         ); 
    this.renderer.paletteOBJ256                 = structuredClone(arg.IOCore.gfxRenderer.renderer.paletteOBJ256      ); 
    this.renderer.palette16                     = structuredClone(arg.IOCore.gfxRenderer.renderer.palette16          ); 
    this.renderer.paletteOBJ16                  = structuredClone(arg.IOCore.gfxRenderer.renderer.paletteOBJ16       );
    
    this.renderer.lineBuffer                    = structuredClone(arg.IOCore.gfxRenderer.renderer.lineBuffer         );

    this.renderer.compositor = {};
    this.renderer.compositor.buffer             = structuredClone(arg.IOCore.gfxRenderer.renderer.compositor.buffer   );   
    this.renderer.compositor.doEffects          = structuredClone(arg.IOCore.gfxRenderer.renderer.compositor.doEffects); 

    this.renderer.bg0Renderer = {};
    this.renderer.bg0Renderer.BGCharacterBaseBlock  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.BGCharacterBaseBlock    );
    this.renderer.bg0Renderer.BGLayer               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.BGLayer                 );
    this.renderer.bg0Renderer.BGScreenBaseBlock     =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.BGScreenBaseBlock       );
    this.renderer.bg0Renderer.BGXCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.BGXCoord                );
    this.renderer.bg0Renderer.BGYCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.BGYCoord                );
    this.renderer.bg0Renderer.do256                 =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.do256                   );
    this.renderer.bg0Renderer.doMosaic              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.doMosaic                );
    this.renderer.bg0Renderer.offset                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.offset                  );
    this.renderer.bg0Renderer.priorityFlag          =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.priorityFlag            );
    this.renderer.bg0Renderer.tileFetched           =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.tileFetched             );
    this.renderer.bg0Renderer.tileMode              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg0Renderer.tileMode                );

    this.renderer.bg1Renderer = {};
    this.renderer.bg1Renderer.BGCharacterBaseBlock  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.BGCharacterBaseBlock    );
    this.renderer.bg1Renderer.BGLayer               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.BGLayer                 );
    this.renderer.bg1Renderer.BGScreenBaseBlock     =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.BGScreenBaseBlock       );
    this.renderer.bg1Renderer.BGXCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.BGXCoord                );
    this.renderer.bg1Renderer.BGYCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.BGYCoord                );
    this.renderer.bg1Renderer.do256                 =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.do256                   );
    this.renderer.bg1Renderer.doMosaic              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.doMosaic                );
    this.renderer.bg1Renderer.offset                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.offset                  );
    this.renderer.bg1Renderer.priorityFlag          =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.priorityFlag            );
    this.renderer.bg1Renderer.tileFetched           =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.tileFetched             );
    this.renderer.bg1Renderer.tileMode              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg1Renderer.tileMode                );

    this.renderer.bg2TextRenderer = {};
    this.renderer.bg2TextRenderer.BGCharacterBaseBlock  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.BGCharacterBaseBlock );
    this.renderer.bg2TextRenderer.BGLayer               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.BGLayer              );
    this.renderer.bg2TextRenderer.BGScreenBaseBlock     =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.BGScreenBaseBlock    );
    this.renderer.bg2TextRenderer.BGXCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.BGXCoord             );
    this.renderer.bg2TextRenderer.BGYCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.BGYCoord             );
    this.renderer.bg2TextRenderer.do256                 =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.do256                );
    this.renderer.bg2TextRenderer.doMosaic              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.doMosaic             );
    this.renderer.bg2TextRenderer.offset                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.offset               );
    this.renderer.bg2TextRenderer.priorityFlag          =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.priorityFlag         );
    this.renderer.bg2TextRenderer.tileFetched           =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.tileFetched          );
    this.renderer.bg2TextRenderer.tileMode              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2TextRenderer.tileMode             );

    this.renderer.bg3TextRenderer = {};
    this.renderer.bg3TextRenderer.BGCharacterBaseBlock  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.BGCharacterBaseBlock );
    this.renderer.bg3TextRenderer.BGLayer               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.BGLayer              );
    this.renderer.bg3TextRenderer.BGScreenBaseBlock     =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.BGScreenBaseBlock    );
    this.renderer.bg3TextRenderer.BGXCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.BGXCoord             );
    this.renderer.bg3TextRenderer.BGYCoord              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.BGYCoord             );
    this.renderer.bg3TextRenderer.do256                 =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.do256                );
    this.renderer.bg3TextRenderer.doMosaic              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.doMosaic             );
    this.renderer.bg3TextRenderer.offset                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.offset               );
    this.renderer.bg3TextRenderer.priorityFlag          =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.priorityFlag         );
    this.renderer.bg3TextRenderer.tileFetched           =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.tileFetched          );
    this.renderer.bg3TextRenderer.tileMode              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg3TextRenderer.tileMode             );

    this.renderer.bgAffineRenderer0 = {};
    this.renderer.bgAffineRenderer0.BGLayer             =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGLayer            );       
    this.renderer.bgAffineRenderer0.BGReferenceX        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGReferenceX       );            
    this.renderer.bgAffineRenderer0.BGReferenceY        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGReferenceY       );            
    this.renderer.bgAffineRenderer0.BGdmx               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGdmx              );     
    this.renderer.bgAffineRenderer0.BGdmy               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGdmy              );     
    this.renderer.bgAffineRenderer0.BGdx                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGdx               );    
    this.renderer.bgAffineRenderer0.BGdy                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.BGdy               );    
    this.renderer.bgAffineRenderer0.doMosaic            =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.doMosaic           );        
    this.renderer.bgAffineRenderer0.offset              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.offset             );      
    this.renderer.bgAffineRenderer0.pb                  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.pb                 );  
    this.renderer.bgAffineRenderer0.pd                  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.pd                 );  
    this.renderer.bgAffineRenderer0.priorityFlag        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer0.priorityFlag       );   
    
    this.renderer.bgAffineRenderer1 = {};
    this.renderer.bgAffineRenderer1.BGLayer             =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGLayer            );       
    this.renderer.bgAffineRenderer1.BGReferenceX        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGReferenceX       );            
    this.renderer.bgAffineRenderer1.BGReferenceY        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGReferenceY       );            
    this.renderer.bgAffineRenderer1.BGdmx               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGdmx              );     
    this.renderer.bgAffineRenderer1.BGdmy               =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGdmy              );     
    this.renderer.bgAffineRenderer1.BGdx                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGdx               );    
    this.renderer.bgAffineRenderer1.BGdy                =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.BGdy               );    
    this.renderer.bgAffineRenderer1.doMosaic            =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.doMosaic           );        
    this.renderer.bgAffineRenderer1.offset              =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.offset             );      
    this.renderer.bgAffineRenderer1.pb                  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.pb                 );  
    this.renderer.bgAffineRenderer1.pd                  =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.pd                 );  
    this.renderer.bgAffineRenderer1.priorityFlag        =  structuredClone(arg.IOCore.gfxRenderer.renderer.bgAffineRenderer1.priorityFlag       );    

    this.renderer.bg2FrameBufferRenderer = {};
    this.renderer.bg2FrameBufferRenderer.frameSelect    =  structuredClone(arg.IOCore.gfxRenderer.renderer.bg2FrameBufferRenderer.frameSelect   );

    this.renderer.bg2MatrixRenderer = {};
    this.renderer.bg2MatrixRenderer.BGCharacterBaseBlock = structuredClone(arg.IOCore.gfxRenderer.renderer.bg2MatrixRenderer.BGCharacterBaseBlock);                
    this.renderer.bg2MatrixRenderer.BGDisplayOverflow    = structuredClone(arg.IOCore.gfxRenderer.renderer.bg2MatrixRenderer.BGDisplayOverflow   );             
    this.renderer.bg2MatrixRenderer.BGScreenBaseBlock    = structuredClone(arg.IOCore.gfxRenderer.renderer.bg2MatrixRenderer.BGScreenBaseBlock   );             
    this.renderer.bg2MatrixRenderer.mapSize              = structuredClone(arg.IOCore.gfxRenderer.renderer.bg2MatrixRenderer.mapSize             );   
    this.renderer.bg2MatrixRenderer.mapSizeComparer      = structuredClone(arg.IOCore.gfxRenderer.renderer.bg2MatrixRenderer.mapSizeComparer     );              

    this.renderer.bg3MatrixRenderer = {};
    this.renderer.bg3MatrixRenderer.BGCharacterBaseBlock = structuredClone(arg.IOCore.gfxRenderer.renderer.bg3MatrixRenderer.BGCharacterBaseBlock);                
    this.renderer.bg3MatrixRenderer.BGDisplayOverflow    = structuredClone(arg.IOCore.gfxRenderer.renderer.bg3MatrixRenderer.BGDisplayOverflow   );             
    this.renderer.bg3MatrixRenderer.BGScreenBaseBlock    = structuredClone(arg.IOCore.gfxRenderer.renderer.bg3MatrixRenderer.BGScreenBaseBlock   );             
    this.renderer.bg3MatrixRenderer.mapSize              = structuredClone(arg.IOCore.gfxRenderer.renderer.bg3MatrixRenderer.mapSize             );   
    this.renderer.bg3MatrixRenderer.mapSizeComparer      = structuredClone(arg.IOCore.gfxRenderer.renderer.bg3MatrixRenderer.mapSizeComparer     );   

    this.renderer.colorEffectsRenderer = {};
    this.renderer.colorEffectsRenderer.alphaBlendAmountTarget1 = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.alphaBlendAmountTarget1);
    this.renderer.colorEffectsRenderer.alphaBlendAmountTarget2 = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.alphaBlendAmountTarget2);
    this.renderer.colorEffectsRenderer.brightnessEffectAmount  = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.brightnessEffectAmount );
    this.renderer.colorEffectsRenderer.colorEffectsType        = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.colorEffectsType       );
    this.renderer.colorEffectsRenderer.effectsTarget1          = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.effectsTarget1         );
    this.renderer.colorEffectsRenderer.effectsTarget2          = structuredClone(arg.IOCore.gfxRenderer.renderer.colorEffectsRenderer.effectsTarget2         );

    this.renderer.mosaicRenderer = {};
    this.renderer.mosaicRenderer.BGMosaicHSize                 = structuredClone(arg.IOCore.gfxRenderer.renderer.mosaicRenderer.BGMosaicHSize );
    this.renderer.mosaicRenderer.BGMosaicVSize                 = structuredClone(arg.IOCore.gfxRenderer.renderer.mosaicRenderer.BGMosaicVSize );
    this.renderer.mosaicRenderer.OBJMosaicHSize                = structuredClone(arg.IOCore.gfxRenderer.renderer.mosaicRenderer.OBJMosaicHSize);
    this.renderer.mosaicRenderer.OBJMosaicVSize                = structuredClone(arg.IOCore.gfxRenderer.renderer.mosaicRenderer.OBJMosaicVSize);

    this.renderer.objRenderer = {};
    this.renderer.objRenderer.cyclesToRender                   = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.cyclesToRender     );
    this.renderer.objRenderer.OAMRAM                           = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.OAMRAM             );
    this.renderer.objRenderer.scratchBuffer                    = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.scratchBuffer      );
    this.renderer.objRenderer.scratchWindowBuffer              = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.scratchWindowBuffer);
    this.renderer.objRenderer.scratchOBJBuffer                 = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.scratchOBJBuffer   );
    this.renderer.objRenderer.OBJMatrixParameters              = structuredClone(arg.IOCore.gfxRenderer.renderer.objRenderer.OBJMatrixParameters);

    this.renderer.objWindowRenderer = {};
    this.renderer.objWindowRenderer.WINOBJOutside              = structuredClone(arg.IOCore.gfxRenderer.renderer.objWindowRenderer.WINOBJOutside);

    this.renderer.window0Renderer = {};
    this.renderer.window0Renderer.WINXCoordLeft                = structuredClone(arg.IOCore.gfxRenderer.renderer.window0Renderer.WINXCoordLeft       );
    this.renderer.window0Renderer.WINXCoordRight               = structuredClone(arg.IOCore.gfxRenderer.renderer.window0Renderer.WINXCoordRight      );
    this.renderer.window0Renderer.WINYCoordBottom              = structuredClone(arg.IOCore.gfxRenderer.renderer.window0Renderer.WINYCoordBottom     );
    this.renderer.window0Renderer.WINYCoordTop                 = structuredClone(arg.IOCore.gfxRenderer.renderer.window0Renderer.WINYCoordTop        );
    this.renderer.window0Renderer.windowDisplayControl         = structuredClone(arg.IOCore.gfxRenderer.renderer.window0Renderer.windowDisplayControl);

    this.renderer.window1Renderer = {};
    this.renderer.window1Renderer.WINXCoordLeft                = structuredClone(arg.IOCore.gfxRenderer.renderer.window1Renderer.WINXCoordLeft       );
    this.renderer.window1Renderer.WINXCoordRight               = structuredClone(arg.IOCore.gfxRenderer.renderer.window1Renderer.WINXCoordRight      );
    this.renderer.window1Renderer.WINYCoordBottom              = structuredClone(arg.IOCore.gfxRenderer.renderer.window1Renderer.WINYCoordBottom     );
    this.renderer.window1Renderer.WINYCoordTop                 = structuredClone(arg.IOCore.gfxRenderer.renderer.window1Renderer.WINYCoordTop        );
    this.renderer.window1Renderer.windowDisplayControl         = structuredClone(arg.IOCore.gfxRenderer.renderer.window1Renderer.windowDisplayControl);

    /* Audio */
    this.AGBDirectSoundA                    =  structuredClone(arg.IOCore.sound.AGBDirectSoundA                  );
    this.AGBDirectSoundAFolded              =  structuredClone(arg.IOCore.sound.AGBDirectSoundAFolded            );
    this.AGBDirectSoundALeftCanPlay         =  structuredClone(arg.IOCore.sound.AGBDirectSoundALeftCanPlay       );
    this.AGBDirectSoundARightCanPlay        =  structuredClone(arg.IOCore.sound.AGBDirectSoundARightCanPlay      );
    this.AGBDirectSoundAShifter             =  structuredClone(arg.IOCore.sound.AGBDirectSoundAShifter           );
    this.AGBDirectSoundATimer               =  structuredClone(arg.IOCore.sound.AGBDirectSoundATimer             );
    this.AGBDirectSoundB                    =  structuredClone(arg.IOCore.sound.AGBDirectSoundB                  );
    this.AGBDirectSoundBFolded              =  structuredClone(arg.IOCore.sound.AGBDirectSoundBFolded            );
    this.AGBDirectSoundBLeftCanPlay         =  structuredClone(arg.IOCore.sound.AGBDirectSoundBLeftCanPlay       );
    this.AGBDirectSoundBRightCanPlay        =  structuredClone(arg.IOCore.sound.AGBDirectSoundBRightCanPlay      );
    this.AGBDirectSoundBShifter             =  structuredClone(arg.IOCore.sound.AGBDirectSoundBShifter           );
    this.AGBDirectSoundBTimer               =  structuredClone(arg.IOCore.sound.AGBDirectSoundBTimer             );
    this.CGBMixerOutputCacheLeft            =  structuredClone(arg.IOCore.sound.CGBMixerOutputCacheLeft          );
    this.CGBMixerOutputCacheLeftFolded      =  structuredClone(arg.IOCore.sound.CGBMixerOutputCacheLeftFolded    );
    this.CGBMixerOutputCacheRight           =  structuredClone(arg.IOCore.sound.CGBMixerOutputCacheRight         );
    this.CGBMixerOutputCacheRightFolded     =  structuredClone(arg.IOCore.sound.CGBMixerOutputCacheRightFolded   );
    this.CGBOutputRatio                     =  structuredClone(arg.IOCore.sound.CGBOutputRatio                   );
    this.PWMBitDepthMask                    =  structuredClone(arg.IOCore.sound.PWMBitDepthMask                  );
    this.PWMBitDepthMaskShadow              =  structuredClone(arg.IOCore.sound.PWMBitDepthMaskShadow            );
    this.PWMWidth                           =  structuredClone(arg.IOCore.sound.PWMWidth                         );
    this.PWMWidthOld                        =  structuredClone(arg.IOCore.sound.PWMWidthOld                      );
    this.PWMWidthShadow                     =  structuredClone(arg.IOCore.sound.PWMWidthShadow                   );
    this.VinLeftChannelMasterVolume         =  structuredClone(arg.IOCore.sound.VinLeftChannelMasterVolume       );
    this.VinRightChannelMasterVolume        =  structuredClone(arg.IOCore.sound.VinRightChannelMasterVolume      );
    this.audioClocksUntilNextEvent          =  structuredClone(arg.IOCore.sound.audioClocksUntilNextEvent        );
    this.audioClocksUntilNextEventCounter   =  structuredClone(arg.IOCore.sound.audioClocksUntilNextEventCounter );
    this.audioIndex                         =  structuredClone(arg.IOCore.sound.audioIndex                       );
    this.audioResamplerFirstPassFactor      =  structuredClone(arg.IOCore.sound.audioResamplerFirstPassFactor    );
    this.audioTicks                         =  structuredClone(arg.IOCore.sound.audioTicks                       );
    this.downsampleInputLeft                =  structuredClone(arg.IOCore.sound.downsampleInputLeft              );
    this.downsampleInputRight               =  structuredClone(arg.IOCore.sound.downsampleInputRight             );
    this.mixerOutputCacheLeft               =  structuredClone(arg.IOCore.sound.mixerOutputCacheLeft             );
    this.mixerOutputCacheRight              =  structuredClone(arg.IOCore.sound.mixerOutputCacheRight            );
    this.mixerSoundBIAS                     =  structuredClone(arg.IOCore.sound.mixerSoundBIAS                   );
    this.nr50                               =  structuredClone(arg.IOCore.sound.nr50                             );
    this.nr51                               =  structuredClone(arg.IOCore.sound.nr51                             );
    this.nr52                               =  structuredClone(arg.IOCore.sound.nr52                             );
    this.nr60                               =  structuredClone(arg.IOCore.sound.nr60                             );
    this.nr61                               =  structuredClone(arg.IOCore.sound.nr61                             );
    this.nr62                               =  structuredClone(arg.IOCore.sound.nr62                             );
    this.nr63                               =  structuredClone(arg.IOCore.sound.nr63                             );
    this.sequencePosition                   =  structuredClone(arg.IOCore.sound.sequencePosition                 );
    this.sequencerClocks                    =  structuredClone(arg.IOCore.sound.sequencerClocks                  );
    this.soundMasterEnabled                 =  structuredClone(arg.IOCore.sound.soundMasterEnabled               );

    this.channel1 = {}; 
    this.channel1.CachedDuty                = structuredClone(arg.IOCore.sound.channel1.CachedDuty               );      
    this.channel1.DutyTracker               = structuredClone(arg.IOCore.sound.channel1.DutyTracker              );      
    this.channel1.Enabled                   = structuredClone(arg.IOCore.sound.channel1.Enabled                  );      
    this.channel1.FrequencyCounter          = structuredClone(arg.IOCore.sound.channel1.FrequencyCounter         );      
    this.channel1.FrequencyTracker          = structuredClone(arg.IOCore.sound.channel1.FrequencyTracker         );      
    this.channel1.ShadowFrequency           = structuredClone(arg.IOCore.sound.channel1.ShadowFrequency          );      
    this.channel1.SweepFault                = structuredClone(arg.IOCore.sound.channel1.SweepFault               );      
    this.channel1.Swept                     = structuredClone(arg.IOCore.sound.channel1.Swept                    );      
    this.channel1.canPlay                   = structuredClone(arg.IOCore.sound.channel1.canPlay                  );      
    this.channel1.consecutive               = structuredClone(arg.IOCore.sound.channel1.consecutive              );      
    this.channel1.currentSampleLeft         = structuredClone(arg.IOCore.sound.channel1.currentSampleLeft        );      
    this.channel1.currentSampleRight        = structuredClone(arg.IOCore.sound.channel1.currentSampleRight       );      
    this.channel1.decreaseSweep             = structuredClone(arg.IOCore.sound.channel1.decreaseSweep            );      
    this.channel1.envelopeSweeps            = structuredClone(arg.IOCore.sound.channel1.envelopeSweeps           );      
    this.channel1.envelopeSweepsLast        = structuredClone(arg.IOCore.sound.channel1.envelopeSweepsLast       );      
    this.channel1.envelopeType              = structuredClone(arg.IOCore.sound.channel1.envelopeType             );      
    this.channel1.envelopeVolume            = structuredClone(arg.IOCore.sound.channel1.envelopeVolume           );      
    this.channel1.frequency                 = structuredClone(arg.IOCore.sound.channel1.frequency                );      
    this.channel1.frequencySweepDivider     = structuredClone(arg.IOCore.sound.channel1.frequencySweepDivider    );      
    this.channel1.lastTimeSweep             = structuredClone(arg.IOCore.sound.channel1.lastTimeSweep            );      
    this.channel1.leftEnable                = structuredClone(arg.IOCore.sound.channel1.leftEnable               );      
    this.channel1.nr10                      = structuredClone(arg.IOCore.sound.channel1.nr10                     );      
    this.channel1.nr11                      = structuredClone(arg.IOCore.sound.channel1.nr11                     );      
    this.channel1.nr12                      = structuredClone(arg.IOCore.sound.channel1.nr12                     );      
    this.channel1.nr14                      = structuredClone(arg.IOCore.sound.channel1.nr14                     );      
    this.channel1.rightEnable               = structuredClone(arg.IOCore.sound.channel1.rightEnable              );      
    this.channel1.timeSweep                 = structuredClone(arg.IOCore.sound.channel1.timeSweep                );      
    this.channel1.totalLength               = structuredClone(arg.IOCore.sound.channel1.totalLength              );      

    this.channel2 = {};
    this.channel2.CachedDuty                = structuredClone(arg.IOCore.sound.channel2.CachedDuty               );
    this.channel2.DutyTracker               = structuredClone(arg.IOCore.sound.channel2.DutyTracker              );
    this.channel2.Enabled                   = structuredClone(arg.IOCore.sound.channel2.Enabled                  );
    this.channel2.FrequencyCounter          = structuredClone(arg.IOCore.sound.channel2.FrequencyCounter         );
    this.channel2.FrequencyTracker          = structuredClone(arg.IOCore.sound.channel2.FrequencyTracker         );
    this.channel2.ShadowFrequency           = structuredClone(arg.IOCore.sound.channel2.ShadowFrequency          );
    this.channel2.canPlay                   = structuredClone(arg.IOCore.sound.channel2.canPlay                  );
    this.channel2.consecutive               = structuredClone(arg.IOCore.sound.channel2.consecutive              );
    this.channel2.currentSampleLeft         = structuredClone(arg.IOCore.sound.channel2.currentSampleLeft        );
    this.channel2.currentSampleRight        = structuredClone(arg.IOCore.sound.channel2.currentSampleRight       );
    this.channel2.envelopeSweeps            = structuredClone(arg.IOCore.sound.channel2.envelopeSweeps           );
    this.channel2.envelopeSweepsLast        = structuredClone(arg.IOCore.sound.channel2.envelopeSweepsLast       );
    this.channel2.envelopeType              = structuredClone(arg.IOCore.sound.channel2.envelopeType             );
    this.channel2.envelopeVolume            = structuredClone(arg.IOCore.sound.channel2.envelopeVolume           );
    this.channel2.frequency                 = structuredClone(arg.IOCore.sound.channel2.frequency                );
    this.channel2.leftEnable                = structuredClone(arg.IOCore.sound.channel2.leftEnable               );
    this.channel2.nr21                      = structuredClone(arg.IOCore.sound.channel2.nr21                     );
    this.channel2.nr22                      = structuredClone(arg.IOCore.sound.channel2.nr22                     );
    this.channel2.nr23                      = structuredClone(arg.IOCore.sound.channel2.nr23                     );
    this.channel2.nr24                      = structuredClone(arg.IOCore.sound.channel2.nr24                     );
    this.channel2.rightEnable               = structuredClone(arg.IOCore.sound.channel2.rightEnable              );
    this.channel2.totalLength               = structuredClone(arg.IOCore.sound.channel2.totalLength              );

    this.channel3 = {};
    this.channel3.Enabled                   = structuredClone(arg.IOCore.sound.channel3.Enabled                  );         
    this.channel3.FrequencyPeriod           = structuredClone(arg.IOCore.sound.channel3.FrequencyPeriod          );                 
    this.channel3.PCM                       = structuredClone(arg.IOCore.sound.channel3.PCM                      );     
    this.channel3.WAVERAM8                  = structuredClone(arg.IOCore.sound.channel3.WAVERAM8                 );          
    this.channel3.WAVERAMBankAccessed       = structuredClone(arg.IOCore.sound.channel3.WAVERAMBankAccessed      );                     
    this.channel3.WAVERAMBankSpecified      = structuredClone(arg.IOCore.sound.channel3.WAVERAMBankSpecified     );                      
    this.channel3.WaveRAMBankSize           = structuredClone(arg.IOCore.sound.channel3.WaveRAMBankSize          );                 
    this.channel3.cachedSample              = structuredClone(arg.IOCore.sound.channel3.cachedSample             );              
    this.channel3.canPlay                   = structuredClone(arg.IOCore.sound.channel3.canPlay                  );         
    this.channel3.consecutive               = structuredClone(arg.IOCore.sound.channel3.consecutive              );             
    this.channel3.counter                   = structuredClone(arg.IOCore.sound.channel3.counter                  );         
    this.channel3.currentSampleLeft         = structuredClone(arg.IOCore.sound.channel3.currentSampleLeft        );                   
    this.channel3.currentSampleRight        = structuredClone(arg.IOCore.sound.channel3.currentSampleRight       );                    
    this.channel3.frequency                 = structuredClone(arg.IOCore.sound.channel3.frequency                );           
    this.channel3.lastSampleLookup          = structuredClone(arg.IOCore.sound.channel3.lastSampleLookup         );                  
    this.channel3.leftEnable                = structuredClone(arg.IOCore.sound.channel3.leftEnable               );            
    this.channel3.nr30                      = structuredClone(arg.IOCore.sound.channel3.nr30                     );      
    this.channel3.nr31                      = structuredClone(arg.IOCore.sound.channel3.nr31                     );      
    this.channel3.nr32                      = structuredClone(arg.IOCore.sound.channel3.nr32                     );      
    this.channel3.nr33                      = structuredClone(arg.IOCore.sound.channel3.nr33                     );      
    this.channel3.nr34                      = structuredClone(arg.IOCore.sound.channel3.nr34                     );      
    this.channel3.patternType               = structuredClone(arg.IOCore.sound.channel3.patternType              );             
    this.channel3.rightEnable               = structuredClone(arg.IOCore.sound.channel3.rightEnable              );                 
    this.channel3.totalLength               = structuredClone(arg.IOCore.sound.channel3.totalLength              );          

    // LSFR7Table
    // LSFR15Table
    this.channel4 = {};
    this.channel4.BitRange                  = structuredClone(arg.IOCore.sound.channel4.BitRange                 );
    this.channel4.Enabled                   = structuredClone(arg.IOCore.sound.channel4.Enabled                  );
    this.channel4.FrequencyPeriod           = structuredClone(arg.IOCore.sound.channel4.FrequencyPeriod          );
    this.channel4.VolumeShifter             = structuredClone(arg.IOCore.sound.channel4.VolumeShifter            );
    this.channel4.cachedSample              = structuredClone(arg.IOCore.sound.channel4.cachedSample             );
    this.channel4.canPlay                   = structuredClone(arg.IOCore.sound.channel4.canPlay                  );
    this.channel4.consecutive               = structuredClone(arg.IOCore.sound.channel4.consecutive              );
    this.channel4.counter                   = structuredClone(arg.IOCore.sound.channel4.counter                  );
    this.channel4.currentSampleLeft         = structuredClone(arg.IOCore.sound.channel4.currentSampleLeft        );
    this.channel4.currentSampleRight        = structuredClone(arg.IOCore.sound.channel4.currentSampleRight       );
    this.channel4.currentVolume             = structuredClone(arg.IOCore.sound.channel4.currentVolume            );
    this.channel4.envelopeSweeps            = structuredClone(arg.IOCore.sound.channel4.envelopeSweeps           );
    this.channel4.envelopeSweepsLast        = structuredClone(arg.IOCore.sound.channel4.envelopeSweepsLast       );
    this.channel4.envelopeType              = structuredClone(arg.IOCore.sound.channel4.envelopeType             );
    this.channel4.envelopeVolume            = structuredClone(arg.IOCore.sound.channel4.envelopeVolume           );
    this.channel4.lastSampleLookup          = structuredClone(arg.IOCore.sound.channel4.lastSampleLookup         );
    this.channel4.leftEnable                = structuredClone(arg.IOCore.sound.channel4.leftEnable               );
    this.channel4.noiseSampleTable          = structuredClone(arg.IOCore.sound.channel4.noiseSampleTable         );
    this.channel4.nr42                      = structuredClone(arg.IOCore.sound.channel4.nr42                     );
    this.channel4.nr43                      = structuredClone(arg.IOCore.sound.channel4.nr43                     );
    this.channel4.nr44                      = structuredClone(arg.IOCore.sound.channel4.nr44                     );
    this.channel4.rightEnable               = structuredClone(arg.IOCore.sound.channel4.rightEnable              );
    this.channel4.totalLength               = structuredClone(arg.IOCore.sound.channel4.totalLength              );

    this.FIFOA = {};
    this.FIFOA.buffer                       = structuredClone(arg.IOCore.sound.FIFOABuffer.buffer                );   
    this.FIFOA.count                        = structuredClone(arg.IOCore.sound.FIFOABuffer.count                 );   
    this.FIFOA.position                     = structuredClone(arg.IOCore.sound.FIFOABuffer.position              );    

    this.FIFOB = {};
    this.FIFOB.buffer                       = structuredClone(arg.IOCore.sound.FIFOBBuffer.buffer                );   
    this.FIFOB.count                        = structuredClone(arg.IOCore.sound.FIFOBBuffer.count                 );   
    this.FIFOB.position                     = structuredClone(arg.IOCore.sound.FIFOBBuffer.position              );    
    ...
    /* Save Data */
    this.saveType               = structuredClone(arg.IOCore.saves.saveType         );
    // TODO: switch reference to saveType?

    this.GPIOChip = {};
    this.GPIOChip.data          = structuredClone(arg.IOCore.saves.GPIOChip.data     );      
    this.GPIOChip.direction     = structuredClone(arg.IOCore.saves.GPIOChip.direction);           
    this.GPIOChip.readWrite     = structuredClone(arg.IOCore.saves.GPIOChip.readWrite);           
    this.GPIOChip.type          = structuredClone(arg.IOCore.saves.GPIOChip.type     );   
    
    this.GPIOChip.RTC = {};
    this.GPIOChip.RTC.pins           = structuredClone(arg.IOCore.saves.GPIOChip.rtc.pins          );
    this.GPIOChip.RTC.direction      = structuredClone(arg.IOCore.saves.GPIOChip.rtc.direction     );
    this.GPIOChip.RTC.totalBytes     = structuredClone(arg.IOCore.saves.GPIOChip.rtc.totalBytes    );
    this.GPIOChip.RTC.bytesRemaining = structuredClone(arg.IOCore.saves.GPIOChip.rtc.bytesRemaining);
    this.GPIOChip.RTC.transferStep   = structuredClone(arg.IOCore.saves.GPIOChip.rtc.transferStep  );
    this.GPIOChip.RTC.reading        = structuredClone(arg.IOCore.saves.GPIOChip.rtc.reading       );
    this.GPIOChip.RTC.bitsRead       = structuredClone(arg.IOCore.saves.GPIOChip.rtc.bitsRead      );
    this.GPIOChip.RTC.bits           = structuredClone(arg.IOCore.saves.GPIOChip.rtc.bits          );
    this.GPIOChip.RTC.command        = structuredClone(arg.IOCore.saves.GPIOChip.rtc.command       );
    this.GPIOChip.RTC.control        = structuredClone(arg.IOCore.saves.GPIOChip.rtc.control       );
    this.GPIOChip.RTC.time           = structuredClone(arg.IOCore.saves.GPIOChip.rtc.time          );

    this.UNDETERMINED = {};
    this.UNDETERMINED.saves        = structuredClone(arg.IOCore.saves.UNDETERMINED.saves   );
    this.UNDETERMINED.possible     = structuredClone(arg.IOCore.saves.UNDETERMINED.possible);

    this.SRAMChip = {};
    this.SRAMChip.TILTChip         = structuredClone(arg.IOCore.saves.SRAMChip.TILTChip        );
    this.SRAMChip.TILTChipUnlocked = structuredClone(arg.IOCore.saves.SRAMChip.TILTChipUnlocked);
    this.SRAMChip.saves            = structuredClone(arg.IOCore.saves.SRAMChip.saves           );

    this.FLASHChip = {};
    this.FLASHChip.BANKOffset              = structuredClone(arg.IOCore.saves.FLASHChip.BANKOffset             );    
    this.FLASHChip.flashCommand            = structuredClone(arg.IOCore.saves.FLASHChip.flashCommand           );    
    this.FLASHChip.flashCommandUnlockStage = structuredClone(arg.IOCore.saves.FLASHChip.flashCommandUnlockStage);    
    this.FLASHChip.largestSizePossible     = structuredClone(arg.IOCore.saves.FLASHChip.largestSizePossible    );    
    this.FLASHChip.notATMEL                = structuredClone(arg.IOCore.saves.FLASHChip.notATMEL               );    
    this.FLASHChip.saves                   = structuredClone(arg.IOCore.saves.FLASHChip.saves                  );         
    this.FLASHChip.writeBytesLeft          = structuredClone(arg.IOCore.saves.FLASHChip.writeBytesLeft         );    

    this.EEPROMChip = {};
    this.EEPROMChip.address             = structuredClone(arg.IOCore.saves.EEPROMChip.address            );    
    this.EEPROMChip.bitsProcessed       = structuredClone(arg.IOCore.saves.EEPROMChip.bitsProcessed      );          
    this.EEPROMChip.buffer              = structuredClone(arg.IOCore.saves.EEPROMChip.buffer             );   
    this.EEPROMChip.largestSizePossible = structuredClone(arg.IOCore.saves.EEPROMChip.largestSizePossible);                
    this.EEPROMChip.mode                = structuredClone(arg.IOCore.saves.EEPROMChip.mode               ); 
    this.EEPROMChip.saves               = structuredClone(arg.IOCore.saves.EEPROMChip.saves              );  
    } else {
